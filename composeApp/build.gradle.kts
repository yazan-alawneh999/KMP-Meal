...
android {
    namespace = "com.codingwithyazan.mealapp"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.codingwithyazan.mealapp"
...
compose.desktop {
    application {
        mainClass = "com.codingwithyazan.mealapp.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.codingwithyazan.mealapp"
